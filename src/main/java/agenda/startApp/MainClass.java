...
public class MainClass {
				...
				try {
					switch (chosen) {
						...
						case 4:
							...
							String name = sc.next();
							afisareContacte(contactRep,name);
							break;
					}
				} catch (Exception e) {
	...
	public static Object afisareContacte(RepositoryContact repo, String name){
		if(name != null){
			if(name.contains("!") || name.contains("@") || name.contains("#") || name.contains("$") || name.contains("%") || name.contains("^")
					|| name.contains("&") || name.contains("*") || name.contains("(") || name.contains(")") || name.contains("-")
					|| name.contains("_") || name.contains("=") || name.contains("+") || name.contains(",") || name.contains("."))
				return "Invalid name";
			else
	...
	private static void printMenu() {
		...
		System.out.println("4.Afisare contacte dupa nume\n");
